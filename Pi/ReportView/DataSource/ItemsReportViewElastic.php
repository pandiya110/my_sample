...
class ItemsReportViewElastic implements iItemsReportView{
        ...
        if ($result) {
            foreach ($result as $val) {
                ...
                if ($headerType == 0) {
                    ...
                    $val['local_sources'] = isset($val['local_sources']) && !empty($val['local_sources']) && ($val['local_sources'] != 'Yes') ? $val['local_sources'] : 'Yes';
