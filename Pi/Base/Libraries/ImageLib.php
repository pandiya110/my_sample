		...
		} else // Resize
{
	...
	function set_error($msg) {
		...
		if (is_array ( $msg )) {
			foreach ( $msg as $val ) {
				...
				$msg = ($this->LangLine ( $val ) == FALSE) ? $val : $this->LangLine ( $val );
				$this->error_msg [] = $msg;
				log_message ( 'error', $msg );
			}
		} else {
			$msg = ($this->LangLine ( $msg ) == FALSE) ? $msg : $this->LangLine ( $msg );
			$this->error_msg [] = $msg;
			log_message ( 'error', $msg );
		}
	}
	...
	function LangLine($value) {
		...
		return isset ( $lang [$value] ) ? $lang [$value] : false;
	}
}
function log_message($x, $y) {
}
// END Image_lib Class
